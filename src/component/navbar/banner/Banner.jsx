...
Certification Services</h2>
  ...
  <div className="card-body">
    <h2 className="card-title">ISO 22000:2018 <br /> ₹4000/-
</h2>
    <p className="card-text">Food Safety Management Systems: Ensure the safety and quality of food products and supply chains.</p>
  ...
  <img className="card-img-top w-25 px-2 mx-2 my-2" src={c} alt="Card image cap"/>
  <div className="card-body">
    <h2 className="card-title">ISO 14001:2015 ₹2500/-
</h2>
    <p className="card-text">Environmental Management Systems: Demonstrate your commitment to environmental responsibility and sustainability.</p>
    <a href="#" className="btn ">
                                                See Details                                                </a>
  ...
  <img className="card-img-top w-25 px-2 mx-2 my-2" src={c} alt="Card image cap"/>
  <div className="card-body">
    <h2 className="card-title">ISO 13485:2016 ₹4000/-
</h2>
    <p className="card-text">Medical Devices Quality Management Systems: Ensure the quality and safety of medical devices throughout their lifecycle.</p>
    <a href="#" className="btn ">
                                                See Details                                                </a>
  ...
  <img className="card-img-top w-25 px-2 mx-2 my-2" src={c} alt="Card image cap"/>
  <div className="card-body">
    <h2 className="card-title">ISO 20000:2011 ₹5000/-
</h2>
    <p className="card-text">IT Service Management Systems: Improve the efficiency and effectiveness of your IT service delivery.</p>
    <a href="#" className="btn ">
                                                See Details                                                </a>
  ...
  <img className="card-img-top w-25 px-2 mx-2 my-2" src={c} alt="Card image cap"/>
  <div className="card-body">
    <h2 className="card-title">ISO 22000:2018 ₹4000/-
</h2>
    <p className="card-text">Food Safety Management Systems: Ensure the safety and quality of food products and supply chains.</p>
    <a href="#" className="btn ">
                                                See Details                                                </a>
  ...
  <img className="card-img-top w-25 px-2 mx-2 my-2" src={c} alt="Card image cap"/>
  <div className="card-body">
    <h2 className="card-title">ISO 29993:2010 ₹6000/-
</h2>
    <p className="card-text">Learning Services for Non-Formal Education and Training: Enhance the quality and effectiveness of your training and educational programs.</p>
    <a href="#" className="btn ">
                                                See Details                                                </a>
  ...
  <img className="card-img-top w-25 px-2 mx-2 my-2" src={c} alt="Card image cap"/>
  <div className="card-body">
    <h2 className="card-title">ISO 27001:2022 ₹4000/-
</h2>
    <p className="card-text">Information Security Management Systems: Protect your sensitive information and data assets from security threats.</p>
    <a href="#" className="btn ">
                                                See Details                                                </a>
  ...
  <img className="card-img-top w-25 px-2 mx-2 my-2" src={c} alt="Card image cap"/>
  <div className="card-body">
    <h2 className="card-title">ISO 45001:2018 ₹3000/-
</h2>
    <p className="card-text">Occupational Health and Safety Management Systems: Ensure a safe and healthy work environment for your employees while meeting legal and regulatory requirements.</p>
    <a href="#" className="btn ">
                                                See Details                                                </a>
